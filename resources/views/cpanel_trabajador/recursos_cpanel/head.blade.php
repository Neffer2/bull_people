<head>
    ...
    <meta name="msapplication-TileImage" content="https://www.bullmarketing.com.co/wp-content/uploads/2022/04/cropped-favicon-bull-270x270.png" />
    ...
    <link href="{{ asset('panel/css/cpanel.css') }}" rel="stylesheet" />
    <link href="{{ asset('panel/css/home.css') }}" rel="stylesheet" /> 

    <link href="{{ asset('panel/plugins/multi-select/css/multi-select.css') }}" rel="stylesheet">
    <link href="{{ asset('panel/plugins/bootstrap-select/css/bootstrap-select.css') }}" rel="stylesheet" />
