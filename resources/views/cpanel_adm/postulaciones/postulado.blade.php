            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        @endif
                        <h2> 
                            {{ $postulado->user_info->name }} <small>{{ $postulado->user_info->email }}</small>
                        </h2> 
                        </div> 
                        <div class="body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    margin-left: auto;
                                    margin-right: auto;" src="../img/profiles/{{ $postulado->user_info->avatar }}" width="100" height="100%">                                    
                                </div>
                            </div>
                        </div> 
                        <div class="body">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Ciudad</th>
                                            <th>Cargo</th>
                                            <th>Aspiraci&oacute;n salarial</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr> 
                                            <th scope="row">1</th>
                                            <td>{{ $postulado->user_info->name }}</td>
                                            <td>{{ $postulado->user_info->documento }}</td>
                        ...
                        <div class="body">
                            <div class="iframe_container">
                                <iframe class="responsive_iframe" src="{{ asset("/files/$postulado->hoja_vida") }}"></iframe>
                            </div>
                            <br>
                            <object data="myfile.pdf" type="application/pdf" width="100%" height="100%">
                                <p>Pantalla completa<a target="_blank" href="{{ asset("/files/$postulado->hoja_vida") }}"> hoja de vida</a></p>
                            </object>
                            <a class="btn bg-cyan waves-effect" href="/files/{{ $postulado->hoja_vida }}" download="HV_{{ $postulado->user_info->name }}">
                                ...
                                <div class="row"> 
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <textarea name="descripcion_estado" id="" class="form-control" cols="30" rows="3" placeholder="Comentario de decisi&oacute;n" required>{{ $postulado->descripcion_estado }}</textarea>
                                            </div>
                                            <div class="col-md-6">
